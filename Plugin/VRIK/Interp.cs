...
namespace AvatarScriptPack
{
	...
	public class Interp
	{
		...
		public static float LerpValue(float value, float target, float increaseSpeed, float decreaseSpeed)
		{
			...
			if (value < target)
			{
				return Mathf.Clamp(value + Time.unscaledDeltaTime * increaseSpeed, float.NegativeInfinity, target);
			}
			return Mathf.Clamp(value - Time.unscaledDeltaTime * decreaseSpeed, target, float.PositiveInfinity);
		}
